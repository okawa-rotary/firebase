        ...
        $map.slideToggle({
            complete: function() {
                ...
                if (!isMapLoaded) {
                    ...
                    map = new GMaps({
                    el: '#gmap-wrapper',
                    lat: 33.207691, //Replace Here Location Google Map Latitude
                    lng: 130.373854, //Replace Here Location Google Map Longitude
                    scrollwheel: false,
                    zoom: 17,
                    zoomControl: true,
                    panControl: true,
                    ...
                    var image = '';
                    map.addMarker({
                        lat: 33.207691, //Replace Here Location Google Map Lat
                        lng: 130.373854, //Replace Here Location Google Map Lat
                        icon: image,
